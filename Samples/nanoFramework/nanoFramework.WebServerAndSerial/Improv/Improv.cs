...
{
    /// <summary>
    /// This is coming for a .NET nanoFramework sample. Please check https://github.com/nanoframework/samples.
    /// This class allows to use https://www.improv-wifi.com to setup your device wifi. Note that it is not currently working on iOS.
    /// </summary>
    public class Improv
    {
        ...
        private Buffer SetupRpcResult()
        {
            ...
            byte[] resultBytes = UTF8Encoding.UTF8.GetBytes(_rpcResult);
